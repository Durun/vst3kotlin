...
tresult PLUGIN_API IBStream_read(IBStream* this_ptr, void* buffer, int32 numBytes, int32* numBytesRead = nullptr);
tresult PLUGIN_API IBStream_write(IBStream* this_ptr, void* buffer, int32 numBytes, int32* numBytesWritten = nullptr);
tresult PLUGIN_API IBStream_seek(IBStream* this_ptr, int64 pos, int32 mode, int64* result = nullptr);
